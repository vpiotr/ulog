...
UTEST_FUNC_DEF2(Formatter, PositionalParameters) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "Name: Alice, Age: 30, Name again: Alice");
}
...
UTEST_FUNC_DEF2(Formatter, MixedParameters) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "Anonymous: first, Positional: second, Another: second");
}
...
UTEST_FUNC_DEF2(Formatter, ExcessParameters) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "One: first");
}
...
UTEST_FUNC_DEF2(Formatter, MissingParameters) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "One: first, Two: {?}");
}
...
UTEST_FUNC_DEF2(Formatter, PositionalOutOfRange) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "One: first, Two: {5}");
}
...
UTEST_FUNC_DEF2(Formatter, NoPlaceholders) {
    ...
    UTEST_ASSERT_STR_EQUALS(result, "No placeholders");
}
...
UTEST_FUNC_DEF2(Formatter, UstrToString) {
    ...
    UTEST_ASSERT_STR_EQUALS(ulog::ustr::to_string(str), "test string");
    UTEST_ASSERT_STR_EQUALS(ulog::ustr::to_string(cstr), "test cstring");
    UTEST_ASSERT_STR_EQUALS(ulog::ustr::to_string(num), "123");
}
