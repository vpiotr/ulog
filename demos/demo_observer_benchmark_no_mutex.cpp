...
int main() {
    std::cout << "=== Observer Performance Benchmark - WITHOUT OBSERVER MUTEX (Single Thread) ===" << std::endl;
    std::cout << "ULOG_USE_MUTEX_FOR_OBSERVERS=0" << std::endl;
    std::cout << "Testing single-threaded observer notification performance without mutex protection" << std::endl;
    std::cout << std::endl;
