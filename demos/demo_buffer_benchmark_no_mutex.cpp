...
int main() {
    std::cout << "=== Buffer Write Benchmark - WITHOUT BUFFER/OBSERVER MUTEX (Single Thread) ===" << std::endl;
    std::cout << "ULOG_USE_MUTEX_FOR_BUFFER=0, ULOG_USE_MUTEX_FOR_OBSERVERS=0" << std::endl;
    std::cout << "Testing single-threaded buffer write performance without mutex protection" << std::endl;
    std::cout << std::endl;
